    ...
    <footer className="footer">
      <div className="newsletter-section">
        ...
        <p className="newsletter-description">
          ...
          monthly updates on our initiatives, success stories, campaigns, and how
        ...
        <p className="privacy-note">
          We care about your data in our <a href="#" className="privacy-link">privacy policy</a>
        </p>
      </div>
      ...
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul>
            <li><a href="#">Request as a Student</a></li>
            <li><a href="#">Request as a School</a></li>
